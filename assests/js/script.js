...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Rachana Samboju";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Power BI Developer", "Data Analyst", "Tableau Developer", "Data Enthusiast"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
s1.async=true;
s1.src='https://embed.tawk.to/65d7f6ad8d261e1b5f643973/1hn9pn563';
s1.charset='UTF-8';
...
// End of Tawk.to Live Chat
 ...
 $("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init("y9wgX4ZkQoUhB4Plf");
